        ...
        private void assignTilePieceIcon(final Board board) {
            ...
            if (board.getTile(this.tileID).isOccupied()) {
                try {
                    ...
                    final BufferedImage image = ImageIO.read(new File(defaultPieceImagePath + board.getTile(this.tileID).getPiece().getPieceAlliance().toString().substring(0, 1).toLowerCase() +
